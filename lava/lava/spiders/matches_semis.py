...
#xpath
# all 8th 2 matches
# //td[@colspan = 8 and @class ="hauptlink"]/a[contains(.,"Semi-Finals")]/../../../tr[not(@class)]/td[@class = "zentriert hauptlink"]/a[@title = "Match report"]/@href
...
class SpiderMatches(scrapy.Spider):
    ...
    custom_settings = {
        ...
        'FEED_URI' : 'semis_matches.json',
        'FEED_FORMAT' : 'json',
        'FEED_EXPORT_ENCODING' : 'utf-8'
    }

    def parse(self, response):
        links_matches = response.xpath('//td[@colspan = 8 and @class ="hauptlink"]/a[contains(.,"Semi-Finals")]/../../../tr[not(@class)]/td[@class = "zentriert hauptlink"]/a[@title = "Match report"]/@href').getall()
