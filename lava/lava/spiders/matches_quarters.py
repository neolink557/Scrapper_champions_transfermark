...
#xpath
# all 8th 2 matches
# //td[@colspan = 8 and @class ="hauptlink"]/a[contains(.,"Quarter-Finals")]/../../../tr[not(@class)]/td[@class = "zentriert hauptlink"]/a[@title = "Match report"]/@href
...
class SpiderMatches(scrapy.Spider):
    name = 'matches-quarters'
    start_urls = [
        'https://www.transfermarkt.com/uefa-champions-league/gesamtspielplan/pokalwettbewerb/CL/saison_id/2019'
    ]
    custom_settings = {
        'USER_AGENT': 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:66.0) Gecko/20100101 Firefox/66.0',
        'FEED_URI' : 'quarter_matches.json',
        'FEED_FORMAT' : 'json',
        'FEED_EXPORT_ENCODING' : 'utf-8'
    }

    def parse(self, response):
        links_matches = response.xpath('//td[@colspan = 8 and @class ="hauptlink"]/a[contains(.,"Quarter-Finals")]/../../../tr[not(@class)]/td[@class = "zentriert hauptlink"]/a[@title = "Match report"]/@href').getall()
