...
#xpath
# all group matches
# //div[@class = "large-6 columns"]/div[@class = "box"]/table/tbody/tr[not(@style) and not(@class)]/td[@class = "zentriert hauptlink"]/a/@href
...
class SpiderMatches(scrapy.Spider):
    ...
    custom_settings = {
        ...
        'FEED_URI' : 'group_matches.json',
        'FEED_FORMAT' : 'json',
        'FEED_EXPORT_ENCODING' : 'utf-8'
    }

    def parse(self, response):
        links_matches = response.xpath('//div[@class = "large-6 columns"]/div[@class = "box"]/table/tbody/tr[not(@style) and not(@class)]/td[@class = "zentriert hauptlink"]/a/@href').getall()
