...
#xpath
# all 8th 2 matches
# //td[@colspan = 8 and @class ="hauptlink"]/a[contains(.,"Final")]/../../../tr[not(@class)]/td[@class = "zentriert hauptlink"]/a[@title = "Match report" and @class and @id = "3421017"]/@href
...
class SpiderMatches(scrapy.Spider):
    ...
    custom_settings = {
        ...
        'FEED_URI' : 'final_match.json',
        'FEED_FORMAT' : 'json',
        'FEED_EXPORT_ENCODING' : 'utf-8'
    }

    def parse(self, response):
        links_matches = response.xpath('//td[@colspan = 8 and @class ="hauptlink"]/a[contains(.,"Final")]/../../../tr[not(@class)]/td[@class = "zentriert hauptlink"]/a[@title = "Match report" and @class and @id = "3421017"]/@href').getall()
